...
def setup_logging(level="INFO"):
    ...
    logger.add("logs/pipeline.log", rotation="10 MB", level=level)
...
def run_pipeline(args):
    ...
    if args.multi_image:
        ...
        output = pipeline.generate_multi_image(
            deity=args.deity,
            topic=args.topic,
...
def run_server(args):
    ...
    @app.post("/generate")
    async def generate_endpoint(deity: str = "krishna", topic: str = None):
